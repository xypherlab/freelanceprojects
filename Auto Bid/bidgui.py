...
class Main(QtWidgets.QMainWindow):
        ...
        def __init__(self):
            ...
            self.initUI()
        def initUI(self):
             global emailflag,url,pagehistory,flagtimer
             flagtimer=0
             emailflag=0
             pagehistory="?&pageHistory=0,1"
             #url="https://docs.google.com/forms/d/e/1FAIpQLSfW1xvBnEAl_C7pFCUV1Pq3egnUey4Q1jqY43N5ppkHPENoaw/formResponse"
             #url="https://docs.google.com/forms/d/e/1FAIpQLSeG6MLgdIsFkVuLU4I97CF74_NHVNT3ArC-HhqekkfICFqORg/formResponse"
             url="https://docs.google.com/forms/d/e/1FAIpQLSdz9CPfXp0rHlvRjeAiNYAqbpOeBPhlSFdldTTpu2PCP6BSYQ/formResponse"
             #url="https://docs.google.com/forms/d/e/1FAIpQLSek3p5Ae6RNJ6Rmc8atuVRtTEduMCQpvw8AnDAaQQcyqqSE9w/formResponse"
        ...
        def sendform(self):
            global emailflag,url,pagehistory
            ...
            for z in range(len(np_df)):
                ...
                postsend=url+pagehistory+payload
                print(postsend)
                requests.post(postsend)
                postsend=""
        def Loop(self):
             global emailflag,url,pagehistory,flagtimer
             now = datetime.now()
