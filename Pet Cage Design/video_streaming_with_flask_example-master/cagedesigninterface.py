...
class Main(QtGui.QMainWindow):
    ...
    def Loop(self):
        ...
        if elapsed_time>=20 and flag==1:
            ...
            partR=original_image[120:405,320:530]
            ...
            for i in range(0, num_labels):
                       if sizes[i] >= min_size and sizes[i] <= max_size:
                            ...
                            totalareadogleft=totalareadogleft+sizes[i]
                            z=z+1
            print "Area Left Dog: "+str(totalareadogleft)
            z=0
            min_size = 1000
            max_size = 5000 
            totalarea=0
            ...
            for i in range(0, num_labels):
                       if sizes[i] >= min_size and sizes[i] <= max_size:
                            ...
                            totalareadogright=totalareadogright+sizes[i]
                            z=z+1
            print "Area Right Dog: "+str(totalareadogright)
            #Size
            min_size = 1000
            max_size = 5000 
            mask = np.zeros((labels.shape))
            ...
            self.i1.setPixmap(self.disp)
            #Conveyor
            if totalarealeft>=100 and totalarealeft<=10000 and totalareadogleft<5000:
                #A- Forward B- Stop C- Reverse
                ##############
                ser.write("C,")
                ...
                print sensordata
                ###############
            if totalarearight>=100 and totalarearight<=10000 and totalareadogright<5000:
                #A- Forward B- Stop C- Reverse
                ##############
                ser.write("A,")
                print "Conveyor Activated: Right Side"
                now = "Conveyor Activated: Right Side "+str(datetime.datetime.now())+"\n"
                datedata+=now
                for i in xrange(1):
