...
if (cranecom.available() > 0)
  { 
    ...
    if (indicator=="D")
    {
      float A = cranecom.parseFloat();
      float B = cranecom.parseFloat();
      float C = cranecom.parseFloat();
      float D = cranecom.parseFloat();
      float E = cranecom.parseFloat();
      float F = cranecom.parseFloat();
