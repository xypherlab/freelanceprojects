...
*/
  ...
  sendHexNEC(0x01DF22DDUL, NEC_BIT_COUNT, 1, 38,2);
  delay(10);
  Serial.println(F("Sending NEC_HEX_VALUE @ 38kHz"));
  sendHexNEC(0x11DF22DDUL, NEC_BIT_COUNT, 1, 38,3);
  delay(10); 

  Serial.println(F("Sending NEC_HEX_VALUE @ 38kHz"));
  sendHexNEC(0x21DF22DDUL, NEC_BIT_COUNT, 1, 38,4);
  delay(10); 
  Serial.println(F("Sending NEC_HEX_VALUE @ 38kHz"));
  sendHexNEC(0x31DF22DDUL, NEC_BIT_COUNT, 1, 38,5);
  delay(10); 

  Serial.println(F("Sending NEC_HEX_VALUE @ 38kHz"));
  sendHexNEC(0x41DF22DDUL, NEC_BIT_COUNT, 1, 38,6);
  delay(10); 
  Serial.println(F("Sending NEC_HEX_VALUE @ 38kHz"));
  sendHexNEC(0x51DF22DDUL, NEC_BIT_COUNT, 1, 38,7);
  delay(10);

  Serial.println(F("Sending NEC_HEX_VALUE @ 38kHz"));
  sendHexNEC(0x61DF22DDUL, NEC_BIT_COUNT, 1, 38,8);
  delay(10); 
  Serial.println(F("Sending NEC_HEX_VALUE @ 38kHz"));
  sendHexNEC(0x71DF22DDUL, NEC_BIT_COUNT, 1, 38,9);
  delay(10); 

  Serial.println(F("Sending NEC_HEX_VALUE @ 38kHz"));
  sendHexNEC(0x81DF22DDUL, NEC_BIT_COUNT, 1, 38,10);
  delay(10); 
  Serial.println(F("Sending NEC_HEX_VALUE @ 38kHz"));
  sendHexNEC(0x91DF22DDUL, NEC_BIT_COUNT, 1, 38,11);
  delay(10); 

  Serial.println(F("Sending NEC_HEX_VALUE @ 38kHz"));
  sendHexNEC(0xA1DF22DDUL, NEC_BIT_COUNT, 1, 38,12);
  delay(10); 
  Serial.println(F("Sending NEC_HEX_VALUE @ 38kHz"));
  sendHexNEC(0xB1DF22DDUL, NEC_BIT_COUNT, 1, 38,13);
  delay(10); 
